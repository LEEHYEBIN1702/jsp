...
<body>
   <div class="container">
      <div class="row">
         ...
         <div class="col-4 border">
            ...
            title="로그인 페이지로 이동">로그인</a>
            <span id="btnRegister" class="btn btn-outline-success">회원가입</span>
      ...
      <div class="row">
         ...
         <div class="col-lg-6 cal-md-12 border">
         </div>
      </div>
      <!-- end of row -->
      <div class="row">
   ...
   <div class="position-fixed bottom-0 right-0 p-3"
      ...
      <div id="liveToast" class="toast hide" role="alert"
         aria-live="assertive" aria-atomic="true" data-delay="500">
